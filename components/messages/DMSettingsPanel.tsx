            ...
            <div className="flex flex-col gap-6 p-4">
              ...
              <section>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {/* Beta feedback: "Remove the standalone 'Report user' and 'Block' from the
                      three-dot menu in 1:1 DMs — they now live in the contact info panel
                      instead." Moved to ContactInfoPanel's own Actions section. */}
                </div>
              </section>
